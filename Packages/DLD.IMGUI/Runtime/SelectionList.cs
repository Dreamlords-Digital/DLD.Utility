...
public static class SelectionList
{
	...
	public static int Draw(
		int selected, IList<IGuiLabel> list, GUIStyle elementStyle,
	...
	public static int Draw(
		int selected, IList<IGuiLabel> list, DoubleClickCallback onDoubleClick,
		Func<int, bool> visibilityPredicate)
	{
		...
		for (int i = 0; i < list.Count; ++i)
		{
			...
			if (Event.current.type == EventType.Repaint)
			{
				if (list[i].Label.image != null && !IsWhite(list[i].LabelTint))
				{
					...
					GUI.DrawTexture(new Rect(elementRect.x + leftPadding, elementRect.y, imageWidth, elementRect.height),
	...
	public static int Draw(
		int selected, IList<GUIContent> list, GUIStyle elementStyle,
		DoubleClickCallback onDoubleClick)
	{
	...
	public static (int, int, Rect) Draw(
		int selected, int hovered, GUIContent[] list, GUIStyle elementStyle,
		float width)
	{
	...
	public static (int, int, Rect) Draw(
		int selected, int hovered, GUIContent[] list,
		DoubleClickCallback onDoubleClick)
	{
