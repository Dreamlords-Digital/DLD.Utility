...
public class FloatRangeAttribute : PropertyAttribute
{
	...
	public FloatRangeAttribute(
		string minLabel, string maxLabel, bool useAllAvailableSpace = false,
	...
	public FloatRangeAttribute(
		string label = null, string minLabel = null, string minPostLabel = null, string maxLabel = null, string maxPostLabel = null, bool useAllAvailableSpace = false,
		float lowerLimitMin = float.MinValue, float lowerLimitMax = float.MaxValue, float upperLimitMin = float.MinValue, float upperLimitMax = float.MaxValue)
	{
		Label = label;
		MinLabel = minLabel;
