...
public class DropDownBox<TReturnType>
{
	...
	public struct Entry : IEntry
	{
		...
		public bool HasTooltip => _tooltip != null && _tooltip != GUIContent.none && !string.IsNullOrEmpty(_tooltip.text);
	...
	public void SetGuiStyles(
		string buttonStyle, string entryStyle, string entrySelectedStyle,
