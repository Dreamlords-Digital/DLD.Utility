...
public class SoundPlayer
{
	...
	public void DrawUnremovableSoundEntry(
		string soundAbsolutePath, string soundFilename, string label,
		string description,
	...
	public void DrawChangeableSoundEntry(
		string soundAbsolutePath, string soundFilename, string label,
		string description,
	...
	public void DrawReadOnlySoundEntry(
		string soundAbsolutePath, string soundFilename, string label,
		string description)
	{
		if (!string.IsNullOrEmpty(label) || !string.IsNullOrEmpty(description))
	...
	public void DrawSelectableSoundEntry(
		string soundAbsolutePath, string soundFilename, bool isSelected,
