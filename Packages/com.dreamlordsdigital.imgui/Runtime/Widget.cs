...
public static class Widget
{
	...
	public static void DrawLabelWithValidation(
		string label, Func<string> getWarningMessages,
	...
	public static void DrawLabelWithValidationHorizontal(
		string label, Func<string> getWarningMessages,
		params GUILayoutOption[] options)
	{
		GUILayout.BeginHorizontal();
	...
	public static T DrawEnumHorizontalRadioGroup<T>(
		GUIContent label, T currentValue,
	...
	public static T DrawEnumRadioGroup<T>(
		string label, T currentValue,
		T choice1, string choice1Label,
		T choice2, string choice2Label,
	...
	public static string DrawTextField(
		string label, string description, string inputtedText,
		params GUILayoutOption[] options)
	{
	...
	public static void DrawNonSelectableAssetLabelHorizontal(
		string label, GUIContent val,
		params GUILayoutOption[] options)
	{
	...
	public static void DrawHoverableNonSelectableAssetLabelHorizontal(
	...
	public static void DrawHoverableNonSelectableAssetLabelHorizontal(
		string label, GUIContent val, ref Rect assetRect,
		params GUILayoutOption[] options)
	{
	...
	{
		return DrawIntField(string.Empty, string.Empty, string.Empty, inputId, null, inValue, null, int.MinValue, int.MaxValue - 1, true, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, false, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(label, string.Empty, string.Empty, label, onValueChangeCallback, inValue, null, int.MinValue, int.MaxValue - 1, true, DEFAULT_TEXT_FIELD_STYLE_NAME,
			DEFAULT_TEXT_FIELD_STYLE_NAME, WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, false, false, 0, 0, 0, null, options);
	}

	public static int DrawIntField(string label, string description, int inValue, params GUILayoutOption[] options)
	{
		return DrawIntField(label, string.Empty, description, label + description, null, inValue, null, int.MinValue, int.MaxValue - 1, true, DEFAULT_TEXT_FIELD_STYLE_NAME,
			DEFAULT_TEXT_FIELD_STYLE_NAME, WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, false, false, 0, 0, 0, null, options);
	}

	public static int DrawIntField(string label, string description, int inValue, string inputId, params GUILayoutOption[] options)
	{
		return DrawIntField(label, string.Empty, description, inputId, null, inValue, null, int.MinValue, int.MaxValue - 1, true, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, false, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(label, string.Empty, description, label + description, null, inValue, null, int.MinValue, int.MaxValue - 1, true, DEFAULT_TEXT_FIELD_STYLE_NAME,
			DEFAULT_TEXT_FIELD_STYLE_NAME, WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, false, false, 0, 0, 0, additionalGuiBeside, options);
	}
	...
	{
		return DrawIntField(label, string.Empty, description, label + description, onValueChangeCallback, inValue, null, int.MinValue, int.MaxValue - 1, true, DEFAULT_TEXT_FIELD_STYLE_NAME,
			DEFAULT_TEXT_FIELD_STYLE_NAME, WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, false, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(label, string.Empty, description, label + description, null, inValue, getWarningMessages, int.MinValue, int.MaxValue - 1, true, DEFAULT_TEXT_FIELD_STYLE_NAME,
			DEFAULT_TEXT_FIELD_STYLE_NAME, WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, false, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(string.Empty, string.Empty, string.Empty, inputId, null, inValue, null, int.MinValue, int.MaxValue - 1, true, textfieldStyle, textfieldStyle, WARNING_TEXT_FIELD_STYLE_NAME,
			buttonStyle, true, false, 0, 0, 0, null, options);
	}
	...
	/// <returns></returns>
	public static int DrawIntFieldWithPlusMinus(
		string label,
		int inValue,
		params GUILayoutOption[] options)
	{
	...
	{
		return DrawIntField(label, string.Empty, string.Empty, inputId, null, inValue, null, int.MinValue, maxValue, false, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
	...
	{
		return DrawIntField(label, string.Empty, string.Empty, inputId, null, inValue, null, minValue, maxValue, false, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(label, string.Empty, string.Empty, inputId, null, inValue, null, 0, maxValue, true, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(label, string.Empty, string.Empty, inputId, null, inValue, null, 0, int.MaxValue, true, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}

	public static int DrawPositiveOrZeroIntFieldWithPostLabelAndPlusMinus(
		string label, string postLabel,
	...
	{
		return DrawIntField(label, string.Empty, string.Empty, label, null, inValue, null, 0, int.MaxValue, true, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}

	public static int DrawPositiveOrZeroIntFieldWithPlusMinus(
		string label, string postLabel, string description,
		int inValue, params GUILayoutOption[] options)
	{
		return DrawIntField(label, postLabel, description, $"{label}{postLabel}{description}", null, inValue, null, 0, int.MaxValue, true, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(label, postLabel, description, $"{label}{postLabel}{description}", null, inValue, null, 0, maxValue, true, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}

	public static int DrawPositiveIntFieldWithPlusMinus(
		string label, string postLabel, string description,
	...
	public static int DrawPositiveIntFieldWithPlusMinus(
		string label, string postLabel, string description, string inputId,
		int inValue, int maxValue, params GUILayoutOption[] options)
	{
	...
	{
		return DrawIntField(label, string.Empty, description, $"{label}{description}", null, inValue, null, 0, int.MaxValue, true, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(label, string.Empty, description, $"{label}{description}", null, inValue, null, 0, int.MaxValue, true, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, additionGuiBeside, options);
	}

	public static int DrawPositiveOrZeroIntFieldWithPlusMinus(int inValue, string inputId, params GUILayoutOption[] options)
	{
		return DrawIntField(string.Empty, string.Empty, string.Empty, inputId, null, inValue, null, 0, int.MaxValue, true, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(string.Empty, string.Empty, string.Empty, inputId, null, inValue, null, 0, int.MaxValue, true, textfieldStyle, textfieldStyle, WARNING_TEXT_FIELD_STYLE_NAME, buttonStyle,
			true, false, 0, 0, 0, null, options);
	}
	...
	/// <param name="options"></param>
	/// <returns></returns>
	public static int DrawNonZeroIntFieldWithPlusMinus(
		string label,
		int inValue,
		params GUILayoutOption[] options)
	{
		return DrawIntField(label, string.Empty, string.Empty, label, null, inValue, null, int.MinValue, int.MaxValue - 1, false, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(label, string.Empty, string.Empty, inputId, null, inValue, null, int.MinValue, int.MaxValue - 1, false, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}
	...
	public static int DrawPositiveIntFieldWithPlusMinus(
		...
		params GUILayoutOption[] options)
	{
		return DrawIntField(label, string.Empty, string.Empty, label, null, inValue, null, 1, int.MaxValue - 1, false, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}
	...
	public static int DrawPositiveIntFieldWithPlusMinus(
		...
		params GUILayoutOption[] options)
	{
		return DrawIntField(label, postLabel, description, $"{label}{postLabel}{description}", null, inValue, null, 1, int.MaxValue - 1, false, DEFAULT_TEXT_FIELD_STYLE_NAME,
			DEFAULT_TEXT_FIELD_STYLE_NAME, WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(label, string.Empty, string.Empty, inputId, null, inValue, null, 1, int.MaxValue - 1, false, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}
	...
	{
		return DrawIntField(label, string.Empty, string.Empty, inputId, null, inValue, null, 1, maxValue, false, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME,
			WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}

	public static int DrawPositiveIntFieldWithPostLabelAndPlusMinus(
		string label, string postLabel, string desc,
		string inputId, int inValue, params GUILayoutOption[] options)
	{
	...
	public static int DrawIntFieldWithPlusMinusAndDiceRoll(
		string label, string description,
		...
		return DrawIntField(label, string.Empty, description, label + description, null, inValue, i =>
			{
				...
				return string.Empty;
			}, 1, int.MaxValue - 1, false, DEFAULT_TEXT_FIELD_STYLE_NAME, DEFAULT_TEXT_FIELD_STYLE_NAME, WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, true, numberOfDice,
			numberOfSides,
			bonusToRoll, null, options);
	}
	...
	{
		return DrawIntField(label, string.Empty, description, label + description, null, inValue, null, int.MinValue, int.MaxValue - 1, true, DEFAULT_TEXT_FIELD_STYLE_NAME,
			DEFAULT_TEXT_FIELD_STYLE_NAME, WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, additionalGuiBeside, options);
	}
	...
	public static int DrawIntFieldWithPlusMinus(
		...
		params GUILayoutOption[] options)
	{
		return DrawIntField(label, postLabel, description, label + postLabel + description, null, inValue, null, int.MinValue, int.MaxValue - 1, true, DEFAULT_TEXT_FIELD_STYLE_NAME,
			DEFAULT_TEXT_FIELD_STYLE_NAME, WARNING_TEXT_FIELD_STYLE_NAME, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}
	...
	public static int DrawIntFieldWithPlusMinus(
		...
		params GUILayoutOption[] options)
	{
		return DrawIntField(label, string.Empty, description, label + description, onValueChangeCallback, inValue, getWarningMessages, int.MinValue, int.MaxValue - 1, true, normalGuiStyle,
			highlightGuiStyle, warningGuiStyle, PLUS_MINUS_BUTTON_STYLE_NAME, true, false, 0, 0, 0, null, options);
	}

	public static int DrawIntField(
		string label, string postLabel, string description, string inputId, Action<int> onValueChangeCallback,
	...
	public static int DrawIntField(
		Rect rect, string inputId, Action<int> onValueChangeCallback,
	...
	public static double DrawPositiveNumberField(
		string label, string postLabel, string description,
	...
	public static double DrawNumberField(
		string label, string postLabel, string description, string inputId, Action<double> onValueChangeCallback, double inValue, Func<double, string> getWarningMessages, double minValueAllowed,
		double maxValueAllowed, bool allowZero, bool roundNumber, int decimalPlaces, GUIStyle normalGuiStyle, GUIStyle highlightGuiStyle, GUIStyle warningGuiStyle, Action additionalGuiBeside,
		params GUILayoutOption[] options)
	{
		string warningMessage = null;
		bool validInput = true;
	...
	public static double DrawNumberField(
		Rect rect, string label, string description, string inputId, Action<double> onValueChangeCallback, double inValue, Func<double, string> getWarningMessages, double minValueAllowed,
		double maxValueAllowed, bool allowZero, bool useRect, bool roundNumber, int decimalPlaces, GUIStyle normalGuiStyle, GUIStyle highlightGuiStyle, GUIStyle warningGuiStyle,
		params GUILayoutOption[] options)
	{
		string warningMessage = null;
		bool validInput = true;
	...
	public static float DrawPositiveNumberField(
		string label, string postLabel, string description,
	...
	public static float DrawNumberField(
		string label, string description, string inputId,
	...
	public static float DrawNumberField(
		Rect rect, string label, string description, string inputId, Action<float> onValueChangeCallback, float inValue, Func<float, string> getWarningMessages, float minValueAllowed,
		float maxValueAllowed, bool allowZero, bool useRect, bool roundNumber, int decimalPlaces, GUIStyle normalGuiStyle, GUIStyle highlightGuiStyle, GUIStyle warningGuiStyle,
		params GUILayoutOption[] options)
	{
		string warningMessage = null;
		bool validInput = true;
	...
	public static void DrawDropDownBoxWithDescription<T>(
		string label, string description,
	...
	public static void DrawDropDownBox<T>(
		string label,
		DropDownBox<T> dropDownBox)
	{
		GUILayout.BeginHorizontal();
	...
	public static void DrawDropDownBoxWithDescription<T>(
		GUIContent label, string description,
		DropDownBox<T> dropDownBox)
	{
		GUILayout.BeginVertical();
	...
	static void GetHeightScaledDimensions(
		int actualWidth, int actualHeight, float maxWidth, float maxHeight,
	...
	public static void GetHeightScaledDimensions(
		Texture image, float maxWidth, float maxHeight,
		out float scaledWidth, out float scaledHeight)
	{
		if (image == null)
		{
	...
	static void GetWidthScaledDimensions(
		int actualWidth, int actualHeight, float maxWidth, float maxHeight,
		out float scaledWidth, out float scaledHeight)
	{
		scaledWidth = Mathf.Min(actualWidth, maxWidth);
	...
	public static void GetWidthScaledDimensions(
		Texture2D image, float maxWidth, float maxHeight,
		out float scaledWidth, out float scaledHeight)
	{
		if (image == null)
		{
	...
	public static void GetScaledDimensions(
		Texture2D image, float maxWidth, float maxHeight,
		out float scaledWidth, out float scaledHeight)
	{
		if (image == null)
