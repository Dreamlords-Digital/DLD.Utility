...
public abstract partial class BaseTextDataTests
{
	...
	[Test(Description =
		"Ensure that a tree graph data structure, where each node is of a base type but can have children that are of derived types, will get deserialized properly (using ITextDataIO.FromSerializedString).")]
	...
	[Test(Description =
		"Ensure that a tree graph data structure, where each node is of a base type but can have children that are of derived types, will get deserialized properly (using ITextDataIO.TryLoadFromLocal).")]
	...
	[Test(Description =
		"Ensure that a tree graph data structure, where each node is of a base type but can have children that are of derived types, will get deserialized properly (using ITextDataIO.LoadAllFromLocal).")]
