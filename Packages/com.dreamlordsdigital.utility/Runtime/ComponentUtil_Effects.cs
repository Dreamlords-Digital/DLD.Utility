...
public static partial class ComponentUtil
{
	...
	public static void SetFloat(
		this IReadOnlyList<Material> materials,
	...
	public static void RestoreBindPose(this SkinnedMeshRenderer skinnedMeshRenderer)
	{
		...
		for (int i = 0; i < skinnedMeshRenderer.bones.Length; i++)
		{
			...
			bone.localRotation = Quaternion.LookRotation(localMatrix.GetColumn(2),
				localMatrix.GetColumn(1));
			bone.localScale = new Vector3(localMatrix.GetColumn(0).magnitude,
