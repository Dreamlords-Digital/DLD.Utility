...
public static class ListUtil
{
	...
	public static bool AddIfNotInYet(
		this IList<string> list, string valueToAdd,
	...
	public static void AddRangeIfNotInYet(
		this IList<string> list, IList<string> valuesToAdd,
		StringComparison stringComparison = StringComparison.Ordinal)
	{
		if (valuesToAdd == null)
		{
