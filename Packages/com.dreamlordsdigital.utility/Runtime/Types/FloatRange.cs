...
public struct FloatRange : IEquatable<FloatRange>
{
	...
	public static FloatRange operator +(FloatRange a, int offset) => new FloatRange(a.Min + offset, a.Max + offset);

	public static FloatRange operator +(FloatRange a, float offset) => new FloatRange(a.Min + offset, a.Max + offset);
