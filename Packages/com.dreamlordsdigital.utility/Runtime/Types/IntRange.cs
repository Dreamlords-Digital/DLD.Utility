...
public struct IntRange : IEquatable<IntRange>
{
	...
	public static IntRange operator +(IntRange a, IntRange b) => new IntRange(a.Min + b.Min, a.Max + b.Max, true);

	public static IntRange operator +(IntRange a, int offset) => new IntRange(a.Min + offset, a.Max + offset, true);
